...
function StatCard({ icon, title, value, onClick }) {
    ...
    return (
        <div 
            onClick={onClick}
            className="bg-white p-6 rounded-[7px] shadow-sm flex flex-col justify-between relative group cursor-pointer border border-transparent hover:border-gray-100 transition-all flex-1 overflow-hidden"
        >
