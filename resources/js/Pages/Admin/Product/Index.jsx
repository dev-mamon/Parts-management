...
import { Search, Plus, Pencil, Calendar, MapPin, ImageOff } from "lucide-react";
...
export default function Index({ products }) {
    ...
    const getStatusBadge = (status) => {
        ...
        const theme = config[currentStatus] || config.draft;
                                            ...
                                            >
                                                ...
                                                <td className="py-4 px-4">
                                                    <div className="flex gap-3 max-w-[320px]">
                                                        <div className="w-12 h-12 rounded-lg border overflow-hidden flex-shrink-0 bg-slate-100 flex items-center justify-center">
                                                            {firstImage ? (
                                                                <img
